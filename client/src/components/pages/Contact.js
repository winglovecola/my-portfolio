        ...
        <div id="contact-info" className="contact-me-div">
          ...
          <div id="content-me-content">
            ...
            <form className="form">
              ...
              />
              <br/>
              <button id="submit-btn" type="button" onClick={handleFormSubmit}>Submit</button>
            </form>
            {errorMessage && (
              <div>
                <p className="error-text" style={errorMessageStyle}>{errorMessage}</p>
              </div>
            )}
          </div>
          ...
          <div>
            ...
            <h3>Email:</h3>
            <a href="mailto:winglovework@gmail.com">winglovework@gmail.com</a><br/><br/>
